document.addEventListener("DOMContentLoaded",()=>{
    ...
    // find함수는 앞의 listArray 라는 배열의 여러 원소들을 전부 조사하여 원소 중 pid 키값이 현재 productId변수에 저장된 수와 일치되는 원소를 리턴하여 result라는 변수에 저장한다.
    console.log(result)

    const product1 = document.querySelector(".product1")
    product1.innerHTML = `<div class="common-frame">
                <figure class="img-pro-thumb">
                    <img src="./img/${result[productId].pThumbnail}" alt="${result.pName} 이미지">
                </figure>
                <div class="txt-pro">
                    <h1>${result.pName}</h1>
                    ...
                    <div class="sell-info">
                        ...
                        <div>
                            <div class="box-number">
                                ...
                                <img src="./img/detail-minus.svg" alt="감소버튼">
                                </span>
                                <span class="current-count">1</span>
                                <span class="btn-plus">
                                    <img src="./img/detail-plus.svg" alt="증가버튼">
                                </span>
                            </div>
                        </div>
                    ...
                    <ul class="btns-buy">
                        <li><a href="#" class="btn-heart">
                            <img src="./img/heart.svg" alt="관심상품등록">
                            </a>
                        </li>
                        <li><a href="#">장바구니</a></li>
                        <li><a href="#">구매하기</a></li>
